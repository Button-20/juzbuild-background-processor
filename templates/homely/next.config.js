...
const appConfig = {
    ...
    database: {
        mongoUri: "mongodb+srv://admin:fE7yahiULxkkIjlN@clusterv.m0hmur3.mongodb.net/juzbuild_premierrealty",
    },
    // App Configuration
    app: {
    ...
    email: {
        resendApiKey: process.env.RESEND_API_KEY || "re_AnxzKjTV_GsrUKh9zLQ7AdxjhRSo4hVoA",
