        ...
        <div className="prose prose-lg max-w-none dark:prose-invert **:text-dark dark:**:text-white h2:text-dark dark:h2:text-white h3:text-dark dark:h3:text-white p:text-dark dark:p:text-white li:text-dark dark:li:text-white">
          {content ? (
            ...
            <>
              ...
              <p>
                By accessing and using Homely Real Estate services, you accept
              ...
              <p>
                ...
                Homely Real Estate for personal, non-commercial transitory
              ...
              <p>
                All property listings are provided for informational purposes.
                While we strive to maintain accurate information, property
                details, availability, and pricing may change without notice.
              </p>
              ...
              <p>
                ...
                Policy, which also governs your use of our services.
              </p>
