...
function Carousel({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }) {
    ...
    return ((0, jsx_runtime_1.jsx)(CarouselContext.Provider, { value: {
            ...
            canScrollPrev,
            canScrollNext,
        }, children: (0, jsx_runtime_1.jsx)("div", { onKeyDownCapture: handleKeyDown, className: (0, utils_1.cn)("relative h-full", className), role: "region", "aria-roledescription": "carousel", "data-slot": "carousel", ...props, children: children }) }));
}
function CarouselContent({ className, ...props }) {
    const { carouselRef, orientation } = useCarousel();
    return ((0, jsx_runtime_1.jsx)("div", { ref: carouselRef, className: "overflow-hidden h-full", "data-slot": "carousel-content", children: (0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("inline-flex h-full w-full", orientation === "horizontal" ? "" : "-mt-4 flex-col", className), ...props }) }));
}
function CarouselItem({ className, ...props }) {
    const { orientation } = useCarousel();
    return ((0, jsx_runtime_1.jsx)("div", { role: "group", "aria-roledescription": "slide", "data-slot": "carousel-item", className: (0, utils_1.cn)(" shrink-0 w-full h-full", orientation === "horizontal" ? "" : "pt-4", className), ...props }));
}
